...
/*---------------------------------------------------------------------------
      Funciones elaboradas para la graficacion de funciones lineales
/*-------------------------------------------------------------------------*/
/**
* @brief Imprime una tabla con los valores de "x" y "y"
*\details Esta funcion utiliza una estrutura for para la evaluacion de la funcion con
* cada una de los valores del rango, así como la imprension del valor de "x"
* que corresponde al valor que contiene la variable i, y del valor "y" dado
* por la variable del mismo nombre con el resultado de la funcion evaluada.
*/
/*-------------------------------------------------------------------------*/
void imprimirValores(int vM, int vB, float x1, float x2);
/*-------------------------------------------------------------------------*/
/**
* @brief Grafica una funcion lineal 
*\details Esta funcion hace uso de distintas funciones para hacer la graficacion de
* la funcion estructurada con los valores de entrada.
*/
/*-------------------------------------------------------------------------*/
